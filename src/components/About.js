            ...
            <div className="about_lower">
                ...
                <div className="about_details">
                    <p>Ever got a great <span>Idea</span> stuck in your head but couldnt find a <span>safe</span> and <span>secure</span>  place to note it down?
                        ...
                        Presenting You a <span>Private Note Space</span>  Environment where you can easily save your crazy ideas or secrets without worrying about anyone! What you waiting for??? <span>Hurry Up</span>  and <span>Sign Up</span> to your own SafeNote for <span>FREE!!</span> </p>
